...
import OscillatorStateViz from '@components/islands/OscillatorStateViz';
import SSMLongRangeViz from '@components/islands/SSMLongRangeViz';
...
<OscillatorStateViz client:visible />
...
<SSMLongRangeViz client:visible />
