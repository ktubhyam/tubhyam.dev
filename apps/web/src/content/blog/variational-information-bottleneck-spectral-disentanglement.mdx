---
title: "Variational Information Bottleneck for Spectral Disentanglement"
date: 2026-03-05
description: "How the VIB splits spectral representations into chemistry and instrument — separating what a molecule is from how it was measured. Gradient reversal, beta annealing, and the bug that made everything look like it worked."
tags: ["deep-learning", "spectroscopy", "information-theory", "research"]
draft: false
---
...
The VIB head is pretraining as part of Spektron v3 on QM9S (222K training spectra, 2 instruments simulated via augmentation). The beta annealing, gradient reversal, and MoE gating are all live. Evaluation on the corn moisture benchmark (3 real NIR instruments) is next — that's where the R² > 0.952 target will be tested.
