...
import MaskRatioExplorer from '@components/islands/MaskRatioExplorer';
import OvertoneFlowViz from '@components/islands/OvertoneFlowViz';
...
<MaskRatioExplorer client:visible />
...
<OvertoneFlowViz client:visible />
