...
import PeakMorphologyViz from '@components/islands/PeakMorphologyViz';
import AugmentationConstraintViz from '@components/islands/AugmentationConstraintViz';
...
<PeakMorphologyViz client:visible />
...
<AugmentationConstraintViz client:visible />
