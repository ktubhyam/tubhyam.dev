...
const LINKS: SocialLink[] = [
  ...
  {
    label: "Email",
    href: "mailto:tubhyamkt@gmail.com",
  ...
  {
    label: "Twitter / X",
    href: "https://twitter.com/ktubhyam",
  ...
  },
  {
    ...
    href: "https://scholar.google.com/citations?user=ktubhyam",
    icon: "M5.242 13.769L0 9.5 12 1l12 8.5-5.242 4.269C17.548 11.249 14.978 9.5 12 9.5c-2.978 0-5.548 1.749-6.758 4.269zM12 10a7 7 0 1 0 0 14 7 7 0 0 0 0-14zm0 2a5 5 0 1 1 0 10A5 5 0 0 1 12 12zm0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6z",
    color: "#4285F4",
    handle: "ktubhyam",
    filled: true,
  },
  {
    label: "HuggingFace",
    href: "https://huggingface.co/ktubhyam",
    icon: "M22.2819 10.187a10 10 0 1 0-20.5638 0 .75.75 0 0 0 .0614.287C2.558 12.966 4.728 14.5 7.5 14.5c1.19 0 2.308-.315 3.262-.865.22 1.265 1.317 2.23 2.638 2.23 1.32 0 2.418-.965 2.638-2.23A6.47 6.47 0 0 0 19.2 15.15a.75.75 0 1 0 .6-1.46 5 5 0 0 1-2.14-1.217 10 10 0 0 0 4.542-2.286zm-10.782 4.063a1.138 1.138 0 1 1 0-2.276 1.138 1.138 0 0 1 0 2.276zm-4-5a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5zm8 0a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5z",
    color: "#FFD21E",
    handle: "ktubhyam",
    filled: true,
  },
