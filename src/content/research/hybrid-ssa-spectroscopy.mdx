...
- **Project:** [Spekron](/projects/spekron) — the implementation of this architecture, training on 4x RTX 5090
...
- **Preprocessing:** [SpectraKit](/projects/spectrakit) — the spectral preprocessing library used in Spekron's data pipeline
