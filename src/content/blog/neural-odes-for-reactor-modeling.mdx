...
date: 2025-12-14
description: "How neural ordinary differential equations learn continuous-time reactor dynamics, why physics-informed constraints matter more than architecture size, and what makes digital twins of chemical reactors a fundamentally different problem from weather forecasting."
...
- **Foundation model:** [Spekron](/projects/spekron) — uses similar physics-informed training for spectral data
