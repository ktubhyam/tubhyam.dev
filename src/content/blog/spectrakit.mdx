...
<span class="highlight-teal">619 tests</span>. Zero mypy strict-mode errors. Zero ruff violations. Every public function has tests for:
...
- **Research:** [Hybrid SSA Spectroscopy](/research/hybrid-ssa-spectroscopy) — the paper behind the Spekron training pipeline
