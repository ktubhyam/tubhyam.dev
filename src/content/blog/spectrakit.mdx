...
date: 2026-01-25
description: "Why spectral preprocessing libraries shouldn't have classes, how SpectraKit's functional API over NumPy arrays works, and what 619 tests actually test. Design decisions behind a spectroscopy toolkit with two core dependencies."
...
SpectraKit takes the opposite approach. Every function signature looks like this:
...
Arrays in, arrays out. You can inspect `corrected` before passing it to `smooth_savgol`. You can swap `baseline_als` for `baseline_snip` without changing anything else. You can use these functions inside a for loop, a multiprocessing pool, or a PyTorch data loader.
...
The library handles the preprocessing pipeline that every spectroscopist needs:
...
<TerminalBlock
  ...
  lines={[
    ...
    { spans: [{ text: "" }], delay: 200 },
    { spans: [{ text: "spectrakit v1.7.1 — Spectral Preprocessing Toolkit", color: "teal" }] },
    { spans: [{ text: "" }] },
...
<TerminalBlock
  ...
  lines={[
    ...
    { spans: [{ text: "(1868,)", color: "green" }] },
    { prompt: ">>> ", spans: [
      { text: "a.metadata[\"title\"]", color: "white" },
    ] },
    { spans: [{ text: "'ETHANOL'", color: "green" }] },
  ]}
/>
...
<TerminalBlock
  ...
  lines={[
    ...
    { spans: [{ text: "" }] },
    { spans: [{ text: "# Use standalone", color: "muted" }] },
    { prompt: ">>> ", spans: [
      { text: "clean ", color: "white" },
      { text: "= ", color: "red" },
      { text: "pipe", color: "amber" },
      { text: "(raw_spectra)  ", color: "white" },
      { text: "# (n_samples, n_channels)", color: "muted" },
    ] },
    { spans: [{ text: "" }] },
    { spans: [{ text: "# Or drop into sklearn", color: "muted" }] },
    { prompt: ">>> ", spans: [
      { text: "from ", color: "purple" },
...
619 tests. Zero mypy strict-mode errors. Zero ruff violations. Every public function has tests for:
...
<TerminalBlock
  ...
  lines={[
    ...
    { spans: [
      ...
      { text: "63 passed", color: "green" },
    ] },
    { spans: [
      { text: "tests/test_derivative.py ", color: "white" },
      { text: "48 passed", color: "green" },
    ] },
    { spans: [
      { text: "tests/test_scatter.py ", color: "white" },
      { text: "71 passed", color: "green" },
    ] },
    { spans: [
      { text: "tests/test_transform.py ", color: "white" },
      { text: "42 passed", color: "green" },
    ] },
    { spans: [
      { text: "tests/test_peaks.py ", color: "white" },
      { text: "56 passed", color: "green" },
    ] },
    { spans: [
      { text: "tests/test_similarity.py ", color: "white" },
      { text: "38 passed", color: "green" },
    ] },
    { spans: [
      { text: "tests/test_io.py ", color: "white" },
      { text: "89 passed", color: "green" },
    ] },
    { spans: [
      { text: "tests/test_pipeline.py ", color: "white" },
      { text: "61 passed", color: "green" },
    ] },
    { spans: [{ text: "" }] },
    { spans: [
      { text: "═══ ", color: "muted" },
      { text: "619 passed", color: "green" },
      { text: " in 8.42s ", color: "muted" },
      { text: "═══", color: "muted" },
    ] },
  ]}
/>
