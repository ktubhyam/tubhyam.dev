...
The theory says what is achievable. The model is designed to get there. **Spekron** is a CNN-Transformer encoder with a Variational Information Bottleneck (VIB) that splits the latent space into chemistry and instrument:
