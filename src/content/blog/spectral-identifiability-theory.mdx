...
These predictions are being tested on QM9S (130K molecules with computed IR, Raman, and UV spectra at B3LYP/def2-TZVP). The model architecture is described in the [companion post on the spectral inverse problem](/blog/hello-world).
