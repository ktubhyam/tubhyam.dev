...
- **Research paper:** [Hybrid SSA Spectroscopy](/research/hybrid-ssa-spectroscopy) — the Spekron architecture motivated by this theory
- **Project:** [Spekron](/projects/spekron) — where these theoretical predictions are being empirically tested
