...
Spektron is a self-supervised foundation model for vibrational spectroscopy that achieves few-shot calibration transfer across instruments and modalities.
...
- **Paper:** [Hybrid SSA Spectroscopy](/research/hybrid-ssa-spectroscopy) — the research paper describing Spektron's architecture and results
